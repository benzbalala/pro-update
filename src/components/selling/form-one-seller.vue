    ...
    <div>
        ...
        <div id="form1">
            ...
            <div class="formbox">
                ...
                <input type="tel" ref="phoneNumber" id="phone-number" name="phone-number" class="input-form" placeholder="Phone Number"
                    minlength="10" maxlength="10" v-model="phoneNumber" @input="handlePhoneInput" />
    ...
    methods: {
        ...
        redirectToFormTwoSeller() {
            if (this.validateForm1()) {
                //this.saveDataJson();
                this.getFormOneData();
                this.$router.push("/users/FormTwoSeller");
            }
        }
    }
};
